...
def run_test_fancy_sums_of_digits():
    ...
    n = 2
    expect = 19084
    actual = fancy_sums_of_digits(n)
    print('Test 1 expected :', expect)
    print('actual :', actual)

    # Test 2
    n = 35
    expect2 = 124309
    actual2 = fancy_sums_of_digits(n)
    ...
    n = 3
    expect3 = 30888
    actual3 = fancy_sums_of_digits(n)
